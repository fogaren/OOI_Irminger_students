%% % This script imports data from CTD casts taken during the Irminger 005 cruise and then plots depth profiles using the CTD data
...
legend ({'Cast 6', 'Cast 8', 'Cast 12', 'Cast 15'}, 'FontSize', 7, 'Location', 'southwest')
axis ij
%% %Plot casts with shallower and deeper WVD depths using AOU and density
figure (14); clf
subplot(1,2,1); 
d = nicecolor('bww')
ee = nicecolor('bbk')
...
plot (cast{6}.aou (1:cast{6}.maxindex), cast{6}.D (1:cast{6}.maxindex), 'Linewidth',2, 'Color', ee); hold on; 
plot (cast{8}.aou (1:cast{8}.maxindex), cast{8}.D (1:cast{8}.maxindex),'Linewidth',2, 'Color', ee); hold on;
plot (cast{12}.aou (1:cast{12}.maxindex), cast{12}.D (1:cast{12}.maxindex), 'Linewidth',2, 'Color', ee); hold on;
plot (cast{15}.aou (1:cast{15}.maxindex), cast{15}.D (1:cast{15}.maxindex), 'Linewidth',2, 'Color', ee); hold on;
...
plot (cast{6}.rho0 (1:cast{6}.maxindex), cast{6}.D (1:cast{6}.maxindex), 'Linewidth',2,'Color', ee); hold on; 
plot (cast{8}.rho0 (1:cast{8}.maxindex), cast{8}.D (1:cast{8}.maxindex), 'Linewidth',2,'Color', ee); hold on;
plot (cast{12}.rho0 (1:cast{12}.maxindex), cast{12}.D (1:cast{12}.maxindex), 'Linewidth',2,'Color', ee); hold on;
plot (cast{15}.rho0 (1:cast{15}.maxindex), cast{15}.D (1:cast{15}.maxindex), 'Linewidth',2,'Color', ee); hold on;
...
%% %Plots a map of mooring and CTD cast locations 
figure (13); clf
C = NaN*ones(22,3);
C(1,:) = nicecolor('k');
C(2,:) = nicecolor('k');
