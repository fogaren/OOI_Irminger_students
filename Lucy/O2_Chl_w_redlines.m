...
plot(wfpmerge.time(id_max_season1), wfpmerge.depth_grid, 'r.'); hold on; %want the y axis to be just the location of the max or min O2
plot(wfpmerge.time(id_min_season1), wfpmerge.depth_grid, 'r.'); hold on;
