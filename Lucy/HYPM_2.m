...
filename = ['deployment0001_GI02HYPM-WFP02-03-DOSTAL000-recovered_wfp-dosta_ln_wfp_instrument_recovered_20140912T050204-20150812T103930.nc']; ncdisp(filename)
    ...
    %Optode data
    Yr1_wfp.oxygen = ncread(filename,'dosta_ln_wfp_abs_oxygen')* gain(1,1);%standard_name = 'moles_of_oxygen_per_unit_mass_in_sea_water' units = 'umol kg-1'
...
Yr2_wfpgrid_therm.O2sat = (Yr2_wfpgrid_therm.O2conc./O2equil - 1)*100;
    O2equil = O2sol(Yr3_wfpgrid_therm.S,Yr3_wfpgrid_therm.T);
Yr3_wfpgrid_therm.O2sat = (Yr3_wfpgrid_therm.O2conc./O2equil - 1)*100;
    O2equil = O2sol(Yr4_wfpgrid_therm.S,Yr4_wfpgrid_therm.T);
...
wfpmerge.time = [Yr1_wfpgrid_therm.time_start(Yr1_wfpgrid_therm.ind_pair); Yr2_wfpgrid_therm.time_start(Yr2_wfpgrid_therm.ind_pair); Yr3_wfpgrid_therm.time_start(Yr3_wfpgrid_therm.ind_pair); Yr4_wfpgrid_therm.time_start(Yr4_wfpgrid_therm.ind_pair)];
wfpmerge.depth_grid = Yr1_wfpgrid_therm.depth_grid;
wfpmerge.T = [Yr1_wfpgrid_therm.T Yr2_wfpgrid_therm.T Yr3_wfpgrid_therm.T Yr4_wfpgrid_therm.T];
wfpmerge.S = [Yr1_wfpgrid_therm.S Yr2_wfpgrid_therm.S Yr3_wfpgrid_therm.S Yr4_wfpgrid_therm.S];
wfpmerge.pdens = [Yr1_wfpgrid_therm.pdens Yr2_wfpgrid_therm.pdens Yr3_wfpgrid_therm.pdens Yr4_wfpgrid_therm.pdens];
wfpmerge.O2conc = [Yr1_wfpgrid_therm.O2conc Yr2_wfpgrid_therm.O2conc Yr3_wfpgrid_therm.O2conc Yr4_wfpgrid_therm.O2conc];
wfpmerge.O2sat = [Yr1_wfpgrid_therm.O2sat Yr2_wfpgrid_therm.O2sat Yr3_wfpgrid_therm.O2sat Yr4_wfpgrid_therm.O2sat];
wfpmerge.backscatter = [Yr1_wfpgrid_therm.backscatter Yr2_wfpgrid_therm.backscatter Yr3_wfpgrid_therm.backscatter Yr4_wfpgrid_therm.backscatter];
wfpmerge.chla = [Yr1_wfpgrid_therm.chla Yr2_wfpgrid_therm.chla Yr3_wfpgrid_therm.chla Yr4_wfpgrid_therm.chla];
...
%Make plotting grid
[X,Y] = meshgrid(wfpmerge.time, wfpmerge.therm_grid);
