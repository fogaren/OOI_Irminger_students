...
%% Plot Years 1-4 discrete casts at Irminger OOI site, and line up with corresponding hypm profiles
...
for k = 1:4
    ...
    elseif k == 2
        ...
        wfp_plot = Yr2_wfpgrid.O2conc;
        disc_plot = Yr2_disc;
    elseif k == 3
        cast_list = [1,5,6,7,8,9,10]; %casts in OOI site region, cast 1 only to 121 m
        wfp_plot = Yr3_wfpgrid.O2conc;
        disc_plot = Yr3_disc;
    elseif k == 4
        cast_list = [7,8,10,11,12]; %casts in OOI site region, cast 1 only to 121 m
        wfp_plot = Yr4_wfpgrid.O2conc;
        disc_plot = Yr4_disc;
    end
figure(10 + k); clf
set(gcf,'color','w')
